...
all_translation <- list.files("social_classes/translation", pattern = "csv", full.names = TRUE)
...
all_labels_csv <- list.files("social_classes/labels", pattern = "csv", full.names = TRUE)
