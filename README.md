...
- [X] Add E.O Wright translation
- [X] Add ISCO to ESEG translation (waiting for Guillem's input)
...
- [] All ISCOCOM functions should be if it's not isco88com (not sure this is practical since many surveys will simply have not that many occupations making it indistinguishable to separate say ISCO88COM from ISCO88 and ISCO08. Say you're missing a code: it could be because it's a different class schema or because that occupation is missing from the data).
