---
title: "Exploring translations between social classes"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{exploring-translations-between-social-classes}
...
ess %>%
  ...
  transmute(
    ...
    egp11 = isco68_to_egp11(isco68, self_employed, emplno, label = labs)
  )
```
...
ess %>%
  ...
  transmute(
    ...
    egp11 = isco88_to_egp11(isco88, self_employed, emplno, label = labs),
