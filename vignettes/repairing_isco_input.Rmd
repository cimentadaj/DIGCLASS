...
```
```
#> ! ISCO variable is not a character. Beware that numeric ISCO variables possibly contain lost data. See https://cimentadaj.github.io/socialclasses/articles/repairing_isco_input.html for more details. Converting to a character vector.
...
- Warns that there are some occupations with digit less than 4. If your input ISCO variable is of 3, 2 or 1 digit, you can change it using the `occ_digits` argument set to another number.
