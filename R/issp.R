...
#' between schemas. The source can be found at [https://issp.org/data-download/by-year/](https://issp.org/data-download/by-year/). The columns refer to:
#'
...
#'
#' For how to do a proper analysis of this data in `DIGCLASS` and how to recode this data set, see the vignette "Case study: Exploring Occupations Using The International Social Survey Programme (ISSP)" in the package website.
#'
#' @name issp
#' @format dataframe
NULL
